...
-- All the wrapper classes (Integer, Long, Byte, Double, Float, Short) are subclasses (child) of the abstract class 'Number'. The object of the wrapper class contains or wraps its respective primitive data type. 
...
public class Use_of_wrapper_class {
	...
	public static void main(String[] args) {
		...
		System.out.println(2.5 + 2.5 + name3 + "  " + (1.25 + 1.25) + 0.5 + 1.0 + (2.0 + 3.0)); // 5.03.15 2.50.51.05.0
		System.out.println(name3); // 3.15
		...
		System.out.println(Boolean.parseBoolean(employee1)); // true, you learn this line from this page
		...
		System.out.println(String.valueOf(empId) + "W 57th st"); // 220W 57th st
		...
		System.out.println(String.valueOf(grade) + 3.55f); // 3.1123.55
