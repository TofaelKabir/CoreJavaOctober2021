...
-- (later) Interface cannot be instantiated (cannot create object)
...
-- (later) Contains default and static method only which are non abstract(exception)

4) What is an Abstract class?
-- (later) An abstract class is a super class that cannot be instantiated (can’t create objects).
...
-- (later) implements and extends keyword is used for inheritance
